...
where a.event_date = DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY);
...
WHERE ue.event_date = DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY);
...
WHERE s.event_date = DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY);
